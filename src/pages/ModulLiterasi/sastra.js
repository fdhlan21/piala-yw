...
export default function SastraKontekstual({navigation}) {
  ...
  const saveToStorage = async () => {
    try {
      ...
      await AsyncStorage.setItem('sastra_progress', JSON.stringify(sastraProgress))
  ...
  // Pindah ke teks berikutnya atau selesai modul
      ...
      case 3: // Komposisi Reflektif
        ...
        return (
          <View>
            ...
            <MyInput
              label="Tuliskan refleksi Anda (2 paragraf):"
              multiline
              numberOfLines={8}
